...
PROMPT_TEMPLATE = """
Hello! As an AI developed by OpenAI, I'm serving as a banking assistant for Nova Bankbank. I'm here to provide accurate responses to your banking inquiries.
...
def out_of_context(text):
    greet_dict = {
        ...
        "responses": [
            "Hello. Welcome to Nova Bankbank bank",
...
def main():
    st.title("Nova Bankbank Chatbot")
    st.write("A banking assistant chatbot for Nova Bankbank.")
    ...
    if user_input:
        ...
        # intent = intent_recognition(user_input) -- Commented for faster reponse
        intent = "_"
        # SA = sentiment_analysis(user_input) -- Commented for faster reponse
        SA = "_"
